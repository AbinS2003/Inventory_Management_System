...
public class AddonItemsResponseDTO {
    ...
    public AddonItemsResponseDTO() {
    }

    public AddonItemsResponseDTO(String addonProductId, String addonVariantId, String addonName, Map<String, String> attributes, double price) {
